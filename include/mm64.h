...
/* Extract PGD Entry */
#define PAGING64_ADDR_OFFST(addr) ((addr&PAGING64_ADDR_OFFST_MASK)>>PAGING64_ADDR_OFFST_LOBIT)
//GETVAL(addr,PAGING64_ADDR_OFFST_MASK,PAGING_ADDR_OFFST_LOBIT)
...
/* Masks */
#define PAGING64_ADDR_OFFST_MASK  GENMASK64(PAGING64_ADDR_OFFST_HIBIT,PAGING_ADDR_OFFST_LOBIT)
